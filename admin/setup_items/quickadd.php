...
elseif ($act == 'selplatform')
{
	...
	else
	{
		...
		<script type="text/javascript">
			...
			{
				?>typeIDs[<?php echo $a;?>]=<?php echo $arr[0];?>;type_text[<?php echo $a;?>]='<?php echo mysql_escape_string($arr[1]);?>';<?php
			}
			?>
			<?php
			...
			{
				?>yearIDs[<?php echo $a;?>]=<?php echo $arr['yer_yearID'];?>;year_text[<?php echo $a;?>]='<?php echo mysql_escape_string($arr['yer_year']);?>';<?php
			}
			?>
