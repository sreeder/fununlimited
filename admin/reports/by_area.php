...
// output the criteria form
?>
Please select a platform and a date range to view sales/trades by zip/area code.
<p />
...
<form method="get" action="by_area_print.php" name="bsfrm" onsubmit="return verify(this)">
...
<tr>
	<td bgcolor="<?php echo $pg->color('table-label');?>"><b>Sort:</b></td>
	<td bgcolor="<?php echo $pg->color('table-cell');?>">
		<input type="radio" name="sort" id="saz" value="area_zip" checked="checked" class="nb" />
		<label for="saz">Area/Zip Code</label>

		<input type="radio" name="sort" id="shl" value="high_low" class="nb" />
		<label for="shl">High &rarr; Low</label>

		<input type="radio" name="sort" id="slh" value="low_high" class="nb" />
		<label for="slh">Low &rarr; High</label>
	</td>
</tr>
